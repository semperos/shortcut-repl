...
def query-team value (fn query-team [team] {.group_id team})
def query-groups value (fn query-groups [groups] {.group_ids groups})
def query-teams value (fn query-teams [teams] {.group_ids teams})
...
''';
  ...
  // TODO This together with [removeFnBindings] will obliterate existing bindings. Rename existing ones and restore them in that fn.
...
For more help, consult:
 ...
 - This tool's GitHub repository: https://github.com/semperos/shortcut-repl
""";
}
